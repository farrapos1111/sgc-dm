-- Cobranças avulsas atribuídas a membros (Tesouraria)
-- Mesmo ciclo de status das mensalidades: em_aberto | pago | isento
-- Ao marcar pago → cria cash_entry; ao reabrir → remove cash_entry
