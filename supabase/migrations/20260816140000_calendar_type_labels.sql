-- Permite renomear rótulos das categorias padrão do calendário por capítulo
-- (chapters.settings.calendar_type_labels). Inclui secretaria na permissão de patch.
