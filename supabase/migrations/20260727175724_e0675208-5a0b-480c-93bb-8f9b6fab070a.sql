...
REVOKE ALL ON FUNCTION public.create_member_with_pii(uuid,text,date,text,text,text,text,jsonb,public.member_status,jsonb,text) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.create_member_with_pii(uuid,text,date,text,text,text,text,jsonb,public.member_status,jsonb,text) TO authenticated;